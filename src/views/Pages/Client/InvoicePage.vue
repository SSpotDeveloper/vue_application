  ...
  <div class="p-2">
    ...
    <div>
      <table class="w-full shadow-lg">
        ...
        <tbody>
          <tr v-for="invoice, index in filteredInvoices" :key="index" class="text-center border-y border-slate-300" :class="{'bg-red-100' : invoice.status === 'Unpaid', 'bg-green-100' : invoice.status === 'Paid'}">
